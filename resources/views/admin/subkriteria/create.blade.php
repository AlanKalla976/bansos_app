...
<div class="container-fluid">
    ...
    <div class="d-flex align-items-center mb-4">
        ...
        <div>
            ...
            <small class="text-muted">Tambah sub kriteria baru ke dalam sistem</small>
        </div>
    </div>
    ...
    <div class="card border-0 shadow-sm rounded-4" style="max-width:600px">
        <div class="card-header bg-white border-bottom py-3 rounded-top-4">
            <h6 class="fw-bold mb-0 text-primary">
                <i class="bi bi-node-plus me-2"></i>Form Sub Kriteria Baru
            </h6>
        </div>
            ...
            <form action="{{ route('admin.subkriteria.store') }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="nama"
                           ...
                           value="{{ old('nama') }}"
                           placeholder="Contoh: Sangat Rendah, Rendah, Sedang, Tinggi">
                    @error('nama')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
