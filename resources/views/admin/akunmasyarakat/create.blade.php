...
<div class="container-fluid py-4">
    ...
    <div class="d-flex align-items-center gap-2 mb-4">
        ...
        <div>
            <h4 class="fw-bold mb-0 text-dark">Tambah Akun Masyarakat</h4>
            <small class="text-muted">Isi data berikut untuk mendaftarkan akun baru</small>
        </div>
    </div>
        ...
        <div class="col-lg-7">
            <div class="card shadow-sm border-0">
                <div class="card-body p-4">
                    ...
                    <form action="{{ route('admin.akunmasyarakat.store') }}" method="POST" novalidate>
                        @csrf
