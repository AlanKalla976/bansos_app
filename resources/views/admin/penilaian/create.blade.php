    ...
    <div class="d-flex align-items-center mb-4">
        ...
        <div>
            <h4 class="fw-bold mb-0">
                <i class="bi bi-star me-2 text-primary"></i>Form Penilaian
            </h4>
            <small class="text-muted">Isi penilaian untuk setiap kriteria</small>
        </div>
    </div>
        ...
        <div class="card border-0 shadow-sm rounded-4">
            <div class="card-header bg-white border-bottom py-3 rounded-top-4">
                <h6 class="fw-bold mb-0 text-primary">
                    <i class="bi bi-list-check me-2"></i>Penilaian Per Kriteria
                </h6>
            </div>
            <div class="card-body p-4">
                <div class="row g-4">
                        ...
                        <div class="card border rounded-3 h-100">
                            <div class="card-body p-3">
                                ...
                                <div class="mt-2 text-muted small">
                                    Nilai terpilih:
                                    <span id="label_{{ $k->kriteria_id }}" class="fw-semibold text-primary">-</span>
                                </div>
                            </div>
                        </div>
                    </div>
