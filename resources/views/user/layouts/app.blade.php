...
<head>
    ...
    *, *::before, *::after { box-sizing: border-box; }
    ...
    .sidebar {
        ...
        background: linear-gradient(175deg, var(--secondary) 0%, var(--secondary-dark) 50%, var(--primary-dark) 100%);
    ...
    .page-title { font-size: 1rem; font-weight: 700; color: var(--secondary); margin: 0; line-height: 1.2; }
    ...
    .sidebar-toggle:hover { background: var(--bg); border-color: var(--secondary); }
    ...
    .topbar-icon-btn:hover { background: var(--secondary); border-color: var(--secondary); color: #fff; }
    .topbar-icon-btn .badge-dot { position: absolute; top: 5px; right: 5px; width: 8px; height: 8px; background: var(--gold); border-radius: 50%; border: 2px solid #fff; }
    ...
    .topbar-profile:hover { background: #fff; border-color: var(--secondary); }
    .topbar-avatar {
    ...
    .page-header-title { font-size: 1.25rem; font-weight: 700; color: var(--secondary); margin: 0 0 .2rem; }
    ...
    .card-head h6 { font-weight: 700; margin: 0; font-size: .88rem; color: var(--secondary); display: flex; align-items: center; gap: .5rem; }
    .card-head h6 i { color: var(--accent); }
    ...
    .stat-val { font-size: 1.75rem; font-weight: 800; color: var(--secondary); line-height: 1; }
    .stat-lbl { font-size: .72rem; color: var(--text-muted); margin-top: .25rem; font-weight: 500; }

    /* ── TABLE ── */
    .table { margin: 0; font-size: .83rem; }
    .table thead tr { background: linear-gradient(135deg, var(--secondary) 0%, var(--primary) 100%); }
    ...
    .table tbody tr:hover { background: #EDFAF4 !important; }
    ...
    .btn-primary:hover { background: var(--secondary-dark); border-color: var(--secondary-dark); box-shadow: 0 4px 12px rgba(45,106,79,.3); color: #fff; }
    .btn-success { background: var(--accent); border-color: var(--accent); color: #fff; }
    .btn-success:hover { background: #3d9e6e; border-color: #3d9e6e; color: #fff; }
    ...
    .form-control:focus, .form-select:focus { border-color: var(--secondary); box-shadow: 0 0 0 3px rgba(45,106,79,.12); }
    ...
    .page-link { border-radius: var(--radius-sm) !important; font-size: .78rem; font-weight: 500; color: var(--secondary); border-color: var(--border); padding: .38rem .65rem; transition: var(--transition); }
    .page-link:hover { background: var(--secondary); border-color: var(--secondary); color: #fff; }
