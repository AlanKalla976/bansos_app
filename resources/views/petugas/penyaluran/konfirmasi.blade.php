...
<div class="container-fluid">
    <div class="d-flex align-items-center mb-4">
        <a href="{{ route('admin.petugas.penyaluran.index', ['status' => 'Sudah Dijadwalkan']) }}" class="btn btn-outline-secondary me-3">
        ...
        <div class="col-lg-8">
            <div class="card shadow-sm border-0 rounded-3">
                ...
                <div class="card-body bg-white rounded-bottom">
                    <form action="{{ route('admin.petugas.penyaluran.konfirmasi', $penyaluran->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
